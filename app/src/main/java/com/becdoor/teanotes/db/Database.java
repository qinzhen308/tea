...
public class Database {
    ...
    public Database(String name) {
        this(DJApplication.getInstance(), name);
    }

    public Database(Context context, String name) {
        dbOpenHelper = new DatabaseOpenHelper(context, name, null, DJApplication.getInstance().getVersionCode());
        this.name = name;
    }
    ...
    public synchronized boolean execSql(String sql) {
        ...
        try {
            ...
            Log.w("db", "Failed to exec sql: " + sql);
        }
    ...
    public synchronized Object[][] query(String sql, String[] args) {
        ...
        try {
            ...
            Log.w("db", "Failed to query sql: " + sql);
        } finally {
