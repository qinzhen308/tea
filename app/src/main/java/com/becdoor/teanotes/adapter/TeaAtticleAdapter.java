 ...
 * 精选
 */
public class TeaAtticleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TeaAtticleAdapter(Context context) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ((ItemViewHolder) holder).allLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dataBean.getArticle() != null) {
                    CommonDetailActivity.invoke(mContext, dataBean.getArticle().getCat_id(), dataBean.getArticle().getArticle_id(),true);
                }
            }
        });
    }
