...
public class PreferencesUtils {
    ...
    static {
        try {
            c = DJApplication.getInstance().createPackageContext("com.becdoor.teanotes", Context.CONTEXT_IGNORE_SECURITY);
    ...
    private static SharedPreferences getSP() {
        if (c != null) {
            return c.getSharedPreferences("com.becdoor.teanotes" + "_preferences", Context.MODE_WORLD_READABLE | Context.MODE_WORLD_WRITEABLE);
        } else {
            return PreferenceManager.getDefaultSharedPreferences(DJApplication.getInstance());
        }
    }
