...
import com.becdoor.teanotes.fragment.SearchActiveFragment;
import com.becdoor.teanotes.fragment.SearchArticleFragment;
import com.becdoor.teanotes.fragment.SearchUserFragment;
...
public class SearchResultActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        ((TextView)findViewById(R.id.title)).setText(keywords);
...
//                }
    ...
    private void setupViewPager(ViewPager viewpager) {
        ...
        adapter.addFragment(SearchArticleFragment.newInstance(keywords), "笔记");
        adapter.addFragment(SearchActiveFragment.newInstance(keywords), "活动");
        adapter.addFragment(SearchUserFragment.newInstance(keywords), "用户");
    ...
    private void showCateDialog() {
        this.pop = initSimpalPopWindow(this, cateNameList, new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong) {
                        ...
                        //设置分类
                        ((SearchArticleFragment) adapter.mFragment.get(0)).setCate(selectedCate.cat_id);
                        //刷新当前页
                        ((SearchArticleFragment) adapter.mFragment.get(curIndex)).doRefresh();
                    }
                }
                , tvTab1);
    }
    ...
    public static void invoke(Context context,String keywords) {
